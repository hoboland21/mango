...
#=====================================================================
class gridView(RClass)	 :
#=====================================================================
	# ---------------
	def main(self) :
	# ---------------
		#-------------------------------------------
		self.dateStart = datetime.strptime(self.request.session['dateStart'],"%Y-%m-%d")
		self.dateEnd = datetime.strptime(self.request.session['dateEnd'],"%Y-%m-%d")
...
#			anchor = "<a href=/rsvn/grid/{} > O </a>".format(rsvn.id)
			anchor = "<button class='gbutt' value='{}' name='r' > O </button>".format(rsvn.id)
