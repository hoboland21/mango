...
from rsvn.vc import  detailEditor,grid,detailList
urlpatterns = [

    url(r'^$', detailEditor.RsvnMain.as_view(), name='rsvnmain'),
	url(r'^detail/list/(?P<rsvnid>\d+)/$',detailList.RsvnList.as_view(), name='rsvnlist'),
	url(r'^grid/$',grid.gridView.as_view(), name='grid'),
...
#	url(r'^detail/create2/$',detailEdit2.RsvnCreate.as_view(), name='rsvncreate'),
#	url(r'^detail/update2/(?P<rsvnid>\d+)/$',detailEdit2.RsvnUpdate.as_view(), name='rsvnupdate'),
